...
function swell_customize_register( $wp_customize ) {
    ...
    // Home Video Play/Pause Buttons
    $wp_customize->add_setting( 'swell_play_pause' , array(
        'default'     		=> '0',
        'type' 				=> 'theme_mod',
        'transport' 		=> 'refresh',
        'sanitize_callback'	=> 'swell_sanitize_checkbox'
    ...
    $wp_customize->add_control( 'swell_play_pause', array(
        'label'      => __( 'Add Play and Pause Buttons', 'swell' ),
        'section'    => 'swell_home',
        'settings'   => 'swell_play_pause',
        'type'		 => 'checkbox',
        'priority'   => 35
    ) );

    // Pause When Changing Focus
    $wp_customize->add_setting( 'swell_focus_pause' , array(
            'default'     		=> '0',
            'type' 				=> 'theme_mod',
            'transport' 		=> 'refresh',
            'sanitize_callback'	=> 'swell_sanitize_checkbox'
    ...
    $wp_customize->add_control( 'swell_focus_pause', array(
            'label'      => __( 'Pause video when browser tab/window not in focus (better performance)', 'swell' ),
            'section'    => 'swell_home',
            'settings'   => 'swell_focus_pause',
            'type'		 => 'checkbox',
            'priority'   => 35
    ) );
