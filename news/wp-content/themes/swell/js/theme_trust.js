var Swell =(function($) {
    ...
    var down_arrow = function(){
        ...
        $down.click( function(e){
            ...
            jQuery.scrollTo( ".middle", {easing: 'easeInOutExpo', duration: 1000, offset: -headerHeight} );
        });
...
$('#top-top').on("click",function (event) {
...
function handleScroll() {
		$("body").toggleClass('scroll-down', $(window).scrollTop() > 0);
		$("body").toggleClass('show-back-to-top', $(window).scrollTop() / ($(document).height() - $(window).height()) > 0.75);
}
